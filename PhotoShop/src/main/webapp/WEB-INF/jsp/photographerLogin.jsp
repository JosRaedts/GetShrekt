...
<div class="container">
      ...
      <form class="form-signin" method="post" action="${baseurl}/login/checkPhotographerLogin">
        ...
        <input type="password" name="schoolcode" id="inputSchoolcode" class="form-control" placeholder="<spring:message code="password" text="%password" />" required>
